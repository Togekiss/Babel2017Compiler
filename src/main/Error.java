...
public class Error {
	...
	public static boolean escriuError (int codiError, String variableError, int numLinia, String variableEsperada) {
		...
		case 38: writer.println("[ERR_SEM_8] " + numLinia + ", La condicio no és de tipus LOGIC");
		return true;
		...
		return true;
		//Modificar
		case 312: writer.println("[ERR_SEM_12] " + numLinia + ", La variable i l'expressio tenen tipus diferents. El tipus de la variable es [" + variableEsperada + "] i el de l’expressió es [" + variableError + "]");
		return true;
		...
		case 315: writer.println("[ERR_SEM_15] " + numLinia + ", La funció en declaració te " + variableEsperada + " parametres mentre que en us te " + variableError);
		return true;
		...
		case 322: writer.println("[ERR_SEM_22] " + numLinia + ", Tipus [" + variableError + "] invalid per aquest tipus d'operació");
		return true;
		
		case 323: writer.println("[ERR_SEM_23] " + numLinia + ", No es pot dividir per 0");
		return true;
		
		case 324: writer.println("[ERR_SEM_24] " + numLinia + ", índex estàtic fora de rang");
		return true;
